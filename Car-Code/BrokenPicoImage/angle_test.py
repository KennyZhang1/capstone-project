...
while True:
    ...
    data_gyro2 = package_data(ax, ay, az)
...
#    output1=""
#    if tilt_x1 < -30:
#        output1+="Car moving left: {:.2f},".format(tilt_z1)
#    elif tilt_x1 > 30:
#        output1+="Car moving right: {:.2f},".format(tilt_z1)
#    else:
#        output1+="Car going straight: {:.2f},".format(tilt_z1)
